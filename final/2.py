...
Scan to download full data"""
        ...
        with col2:
            ...
            qr_text_all = f"""Health Data for {len(st.session_state.bmi_users)} users:
Total Underweight: {len([u for u in st.session_state.bmi_users if u['Category'] == 'Underweight'])}
Total Normal: {len([u for u in st.session_state.bmi_users if u['Category'] == 'Normal weight'])}
Total Overweight: {len([u for u in st.session_state.bmi_users if u['Category'] == 'Overweight'])}
Total Obese: {len([u for u in st.session_state.bmi_users if u['Category'] == 'Obese'])}
